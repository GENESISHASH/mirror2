...
(function() {
  var Proxy, connect, harmon, http, httpProxy, https, iced, log, logger, mitm, _, __iced_k, __iced_k_noop,
    __slice = [].slice,
  ...
  module.exports = Proxy = (function(_super) {
    ...
    Proxy.prototype.setup_http = function() {
      ...
      this.http_proxy = httpProxy.createProxyServer({
        ...
        hostRewrite: true,
        secure: false,
        target: "https://" + this.opt.host
      });
      this.http_proxy.on('proxyReq', (function(_this) {
        return function(preq, req, res, opts) {
