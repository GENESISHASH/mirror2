...
(function() {
  var Proxy, ProxyManager, connect, http, httpProxy, iced, log, proxy_man, _, __iced_deferrals, __iced_k, __iced_k_noop,
    __slice = [].slice,
    ...
    proxy_man = new ProxyManager({
      hosts: {
        'localhost': {
          ...
          script: "<script>alert('stackoverflow')</script>"
        },
        'proxy.com': {
          host: 'greatist.com',
          script: "<script>alert('greatist.com')</script>"
        }
      }
    });
