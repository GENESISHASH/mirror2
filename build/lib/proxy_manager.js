...
(function() {
  var Proxy, ProxyManager, connect, http, httpProxy, iced, log, logger, proxy_man, _, __iced_k, __iced_k_noop,
    __slice = [].slice,
    ...
    proxy_man = new ProxyManager({
      ...
      hosts: {
        'localhost': {
          ...
          append_head: "<script>console.log('mirror-stackoverflow')</script>"
        },
        'proxy.com': {
          host: 'greatist.com',
          html_modifiers: [
          ...
          append_head: "<script>console.log('mirror-greatist.com')</script>"
        }
      }
    });
    proxy_man.setup(function() {
